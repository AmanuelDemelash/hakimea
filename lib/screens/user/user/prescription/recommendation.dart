                            ...
                            children: [
                              ...
                              ListTile(
                                leading:CircleAvatar(
                                  radius:21,
                                  backgroundImage: NetworkImage(medcins[index]["logo_url"]),
                                ),
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    RatingBar.builder(
                                      initialRating:double.parse(medcins[index]["rate"].toString()),
                                      minRating: 1,
                                    ...
                                    Row(
                                      children: [
                                       const FaIcon(FontAwesomeIcons.locationDot,size: 17,),
                              ...
                              Padding(
                                ...
                                child: Column(
                                  children:List.generate(medcins[index]["medicines"].length, (index) =>
                                      Padding(
                                    ...
                                    children:[
                                        Text(medcins[index]["medicines"][index]["name"]),
                                        Text("ETB ${medcins[index]["medicines"][index]["price"]}",style: TextStyle(color: Constants.primcolor),)
                                    ],
                                  ),
                                      ) ,
                                  )),
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text("ETB ${medcins[index]["medicine_total"]}",style:const TextStyle(color: Constants.primcolor),)
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Text("ETB ${medcins[index]["total_price"]-medcins[index]["medicine_total"]}",style:const TextStyle(color: Constants.primcolor),)
                                      ],
                                    ),
                                    const SizedBox(height: 10,),
                                    ...
                                    Row(
                                      ...
                                      children:[
                                       const Text("Total price",style: TextStyle(fontWeight: FontWeight.bold),),
                                        Text("ETB ${medcins[index]["total_price"]}",style:const TextStyle(color: Constants.primcolor,fontWeight: FontWeight.bold),)
                                      ],
                                    ),
                                  ],
                                ),
